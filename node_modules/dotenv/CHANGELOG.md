...
- ðŸŽ‰ Added new sponsor [Graphite](https://graphite.dev/?utm_source=github&utm_medium=repo&utm_campaign=dotenv) - *the AI developer productivity platform helping teams on GitHub ship higher quality software, faster*.
...
- ðŸž Fix recent regression when using `path` option. return to historical behavior: do not attempt to auto find `.env` if `path` set. (regression was introduced in `16.4.3`) [#814](https://github.com/motdotla/dotenv/pull/814)

## [16.4.4](https://github.com/motdotla/dotenv/compare/v16.4.3...v16.4.4) (2024-02-13)

### Changed

- ðŸž Replaced chaining operator `?.` with old school `&&` (fixing node 12 failures) [#812](https://github.com/motdotla/dotenv/pull/812)
...
- Add `.env.vault` support. ðŸŽ‰ ([#730](https://github.com/motdotla/dotenv/pull/730))
...
- _Breaking:_ Backtick support ðŸŽ‰ ([#615](https://github.com/motdotla/dotenv/pull/615))
...
- Properly parse empty single or double quoted values ðŸž ([#614](https://github.com/motdotla/dotenv/pull/614))
...
- Preserve backwards compatibility on values containing `#` ðŸž ([#603](https://github.com/motdotla/dotenv/pull/603))

## [14.3.1](https://github.com/motdotla/dotenv/compare/v14.3.0...v14.3.1) (2022-01-25)

### Changed

- Preserve backwards compatibility on exports by re-introducing the prior in-place exports ðŸž ([#606](https://github.com/motdotla/dotenv/pull/606))

## [14.3.0](https://github.com/motdotla/dotenv/compare/v14.2.0...v14.3.0) (2022-01-24)

### Added

- Add `multiline` option ðŸŽ‰ ([#486](https://github.com/motdotla/dotenv/pull/486))
...
- Add `override` option ðŸŽ‰ ([#595](https://github.com/motdotla/dotenv/pull/595))
...
- _Breaking:_ Support inline comments for the parser ðŸŽ‰ ([#568](https://github.com/motdotla/dotenv/pull/568))
